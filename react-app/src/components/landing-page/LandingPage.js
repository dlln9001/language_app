    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col items-center mt-4 md:mt-10 md:w-[450px] mx-8 w-fit">
                ...
                {loadingPrompt && 
                    <div role="status">
                        <svg aria-hidden="true" class="w-12 h-12 text-gray-200 animate-spin dark:text-gray-300 fill-teal-700" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
